...
const variants = {
  ...
  inverse:
    'shadow hover:shadow-md text-green-400 bg-white border border-transparent hover:bg-gray-100 disabled:bg-white',
  link: 'text-green-500 border border-transparent hover:text-green-600 hover:underline disabled:text-green-500',
};

const outlineVariants = {
  primary:
    'text-green-500 border border-green-500 hover:bg-green-500 hover:text-white disabled:bg-transparent disabled:text-green-500',
  secondary:
    'text-gray-500 border border-gray-500 hover:bg-gray-500 hover:text-white disabled:bg-transparent disabled:text-gray-500',
  muted:
