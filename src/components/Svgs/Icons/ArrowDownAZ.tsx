...
interface ArrowDownAZProps extends SVGProps<SVGSVGElement> {
  title?: string;
}

const ArrowDownAZ: FC<ArrowDownAZProps> = ({ title = 'Sort', ...rest }) => (
  <svg
    aria-hidden="true"
    focusable="false"
    role="img"
