...
interface ArrowDownZAProps extends SVGProps<SVGSVGElement> {
  title?: string;
}

const ArrowDownZA: FC<ArrowDownZAProps> = ({ title = 'Sort', ...rest }) => (
  <svg
    aria-hidden="true"
    focusable="false"
    role="img"
