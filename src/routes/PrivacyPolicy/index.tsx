...
const PrivacyPolicy: FC<PrivacyPolicyProps> = () => {
  return (
    <PublicPage title="Privacy Policy">
      <h2 className="font-bold text-xl text-gray-600 dark:text-gray-500 mb-4">Privacy Policy</h2>
      ...
      <p className="mb-4">
        ...
        website with regards to the information that they shared and/or collect in babel chat. This
        ...
        <Anchor href="https://www.generateprivacypolicy.com/">Privacy Policy Generator</Anchor>.
      </p>
      ...
      <p className="mb-4">
        babel chat follows a standard procedure of using log files. These files log visitors when
      ...
      <p className="mb-4">
        ...
        <Anchor href="https://www.privacypolicyonline.com/what-are-cookies/">
      ...
      <p className="mb-4">
        ...
        Beacons that are used in their respective advertisements and links that appear on babel
        chat, which are sent directly to users' browser. They automatically receive your IP address
      ...
      <p className="mb-4">
        Note that babel chat has no access to or control over these cookies that are used by
      ...
      <p className="mb-4">
        babel chat's Privacy Policy does not apply to other advertisers or websites. Thus, we are
      ...
      <p className="mb-4">
        babel chat does not knowingly collect any Personal Identifiable Information from children
