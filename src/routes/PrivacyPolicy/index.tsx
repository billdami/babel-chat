...
const PrivacyPolicy: FC<PrivacyPolicyProps> = () => {
  ...
  return (
    <div className="w-full sm:w-4/5 md:w-3/4 lg:w-3/5 xl:w-1/2 mx-auto p-4">
      <Helmet>
        <title>Privacy Policy | babel chat</title>
      </Helmet>
      <div className="mt-4 md:mt-10">
        ...
        <div className="p-4 md:p-6 mb-4 bg-white rounded text-gray-700">
          ...
          <p className="mb-4">
            ...
            our website with regards to the information that they shared and/or collect in babel
            chat. This policy is not applicable to any information collected offline or via channels
          ...
          <p className="mb-4">
            ...
            chat, which are sent directly to users' browser. They automatically receive your IP
          ...
          <p className="mb-4">
            babel chat does not knowingly collect any Personal Identifiable Information from
