        ...
        <div className="mt-4 md:mt-10">
          ...
          <div className="p-4 md:p-6 mb-4 bg-white dark:bg-gray-800 rounded text-gray-700 dark:text-gray-400">
            ...
            <p className="mb-4">
              ...
              chat. This policy is not applicable to any information collected offline or via
              channels other than this website. Our Privacy Policy was created with the help of the{' '}
              <Anchor href="https://www.generateprivacypolicy.com/">
            ...
            <p className="mb-4">
              ...
              babel chat, which are sent directly to users' browser. They automatically receive your
