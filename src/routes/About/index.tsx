      ...
      <div className="w-full sm:w-4/5 md:w-3/4 lg:w-3/5 xl:w-1/2 mx-auto p-4">
        <div className="mt-4 md:mt-10">
          ...
          <div className="p-4 md:p-6 mb-4 bg-white dark:bg-gray-800 rounded text-gray-700 dark:text-gray-400">
            ...
            <p className="mb-4">
              babel chat is designed to be fast, easy-to-use, and work on any device, including
              mobile phones, iPads and other tablets, and desktop PCs. It is capable of supporting
              thousands of simultaneous users, so it will always be stable and available.
            </p>
            <p className="mb-4">
              With intuitive and fast search and filter features, you can easily find people you
            ...
            <p className="mb-4">
              ...
              you find, or send us suggestions for changes and new features. You can do so within
              the app via the 'Give us feedback' option, or by contacting us on Twitter at{' '}
