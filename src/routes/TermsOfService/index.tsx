      ...
      <div className="w-full sm:w-2/3 lg:w-1/2 mx-auto">
        ...
        <div className="p-4 md:p-6 mb-4 bg-white rounded text-gray-700">
          <div className="TermsOfService">
            <h2 className="font-bold text-xl text-gray-600 mb-4">Terms of Service</h2>

            <p className="mb-4">Welcome to babel chat!</p>

            <p className="mb-4">
              These terms and conditions outline the rules and regulations for the use of babel
              chat's Website, located at https://babelchat.online.
            </p>

            <p className="mb-4">
              By accessing this website we assume you accept these terms and conditions. Do not
              continue to use babel chat if you do not agree to take all of the terms and conditions
              stated on this page.
            </p>
            ...
            <p className="mb-4">
              We employ the use of cookies. By accessing babel chat, you agreed to use cookies in
              agreement with the babel chat's Privacy Policy.{' '}
            </p>
            ...
            <p className="mb-4">
              ...
              rights for all material on babel chat. All intellectual property rights are reserved.
              You may access this from babel chat for your own personal use subjected to
            ...
            <p className="mb-4">
              ...
              information in certain areas of the website. babel chat does not filter, edit, publish
              or review Comments prior to their presence on the website. Comments do not reflect the
              views and opinions of babel chat,its agents and/or affiliates. Comments reflect the
              views and opinions of the person who post their views and opinions. To the extent
              permitted by applicable laws, babel chat shall not be liable for the Comments or for
            ...
            <p className="mb-4">
              babel chat reserves the right to monitor all Comments and to remove any Comments which
            ...
            <p className="mb-4">
              You hereby grant babel chat a non-exclusive license to use, reproduce, edit and
            ...
            <p className="mb-4">
              ...
              from the visibility of the hyperlink compensates the absence of babel chat; and (d)
            ...
            <p className="mb-4">
              No use of babel chat's logo or other artwork will be allowed for linking absent a
