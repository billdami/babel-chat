...
const TermsOfService: FC<TermsOfServiceProps> = () => {
  return (
    <PublicPage title="Terms of Use">
      <h2 className="font-bold text-xl text-gray-600 dark:text-gray-500 mb-4">Terms of Use</h2>
      ...
      <p className="mb-4">
        ...
        to use babel chat if you do not agree to take all of the terms and conditions stated on this
        page.
      </p>
      ...
      <p className="mb-4">
        We employ the use of cookies. By accessing and signing into babel chat, you agreed to use
        cookies in agreement with the babel chat's <Link to="/privacy-policy">Privacy Policy</Link>.{' '}
      </p>
      ...
      <p className="mb-4">
        ...
        rights for all material on babel chat. All intellectual property rights are reserved. You
        may access this from babel chat for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p className="mb-4">You must not:</p>
      <ul className="list-disc pl-8 mb-4">
        <li>Republish material from babel chat</li>
        <li>Sell, rent or sub-license material from babel chat</li>
        <li>Reproduce, duplicate or copy material from babel chat</li>
        <li>Redistribute content from babel chat</li>
      </ul>

      <p className="mb-4">
        This Agreement shall begin on the date hereof. Our Terms and Conditions were created with
        the help of the{' '}
        <Anchor href="https://www.termsandconditionsgenerator.com" target="_blank" rel="noreferrer">
          Terms And Conditions Generator
        </Anchor>{' '}
        and the{' '}
        <Anchor href="https://www.generateprivacypolicy.com" target="_blank" rel="noreferrer">
      ...
      <p className="mb-4">
        ...
        information in certain areas of the website. babel chat does not filter, edit, publish or
        review Comments prior to their presence on the website. Comments do not reflect the views
        and opinions of babel chat,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, babel chat shall not be liable for the Comments or for any liability,
        damages or expenses caused and/or suffered as a result of any use of and/or posting of
        and/or appearance of the Comments on this website.
      </p>

      <p className="mb-4">
        babel chat reserves the right to monitor all Comments and to remove any Comments which can
      ...
      <p className="mb-4">
        You hereby grant babel chat a non-exclusive license to use, reproduce, edit and authorize
      ...
      <p className="mb-4">
        ...
        visibility of the hyperlink compensates the absence of babel chat; and (d) the link is in
      ...
      <p className="mb-4">
        ...
        linking to our website, you must inform us by sending an e-mail to babel chat. Please
      ...
      <p className="mb-4">
        No use of babel chat's logo or other artwork will be allowed for linking absent a trademark
        license agreement.
      </p>
      ...
      <h3 className="font-bold text-lg text-gray-600 dark:text-gray-500 mb-4">Content Liability</h3>
      ...
      <h3 className="font-bold text-lg text-gray-600 dark:text-gray-500 mb-4">Your Privacy</h3>
