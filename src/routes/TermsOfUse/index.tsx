      ...
      <div className="w-full sm:w-2/3 lg:w-1/2 mx-auto">
        ...
        <div className="p-4 md:p-6 mb-4 bg-white rounded text-gray-700">
          ...
          <p className="mb-4">
            ...
            Website, located at https://babelchat.online.
          </p>
          ...
          <p className="mb-4">
            ...
            You may access this from babel chat for your own personal use subjected to restrictions
          ...
          <p className="mb-4">
            ...
            permitted by applicable laws, babel chat shall not be liable for the Comments or for any
          ...
          <p className="mb-4">
            ...
            visibility of the hyperlink compensates the absence of babel chat; and (d) the link is
